...
namespace MagicMirrorIotServer.Api.Migrations
{
    ...
    [Migration("20240101095609_AddTagReading")]
    partial class AddTagReading
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MagicMirrorIotServer.Domain.AggregateModels.EonNodeAggregate.Device", b =>
                {
                    ...
                    b.Property<string>("DeviceProtocol")
                        .IsRequired()
            ...
            modelBuilder.Entity("MagicMirrorIotServer.Domain.AggregateModels.Metrics.TagReading<bool>", b =>
                {
                    ...
                    b.ToTable("BoolTagReadings");
                });

            modelBuilder.Entity("MagicMirrorIotServer.Domain.AggregateModels.Metrics.TagReading<double>", b =>
                {
                    b.Property<int>("TagId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("DoubleTagReadings");
                });

            modelBuilder.Entity("MagicMirrorIotServer.Domain.AggregateModels.Metrics.TagReading<int>", b =>
                {
                    b.Property<int>("TagId")
                        .HasColumnType("int");
